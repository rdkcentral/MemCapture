...
- CLI parser maps exact strings to those enum values; unknown strings emit `fprintf(stderr, ...)` warnings and terminate with `exit(EXIT_FAILURE)` (`main.cpp:116` through `main.cpp:130`).
